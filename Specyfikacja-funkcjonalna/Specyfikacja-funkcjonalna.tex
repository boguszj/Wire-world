...
Gdyby w systemie zabrakło pamięci program nie będzie w stanie funkcjonować poprawnie. Program wyświetli komunikat o błędzie i przerwie poprosi o próbę wczytania mniejszej planszy lub uruchomienia programu później.
