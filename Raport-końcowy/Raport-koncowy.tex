...
Ogólny opis zaimplementowanych funkcjonalności wraz z interfejsem graficznym.

\begin{figure}[H]
	\centering
	\def\svgwidth{\columnwidth}
	\includegraphics[width=13cm]{Obrazy/wireworld.png}
	\caption{2.1 -- GUI WireWorld}
	\includegraphics[width=13cm]{Obrazy/gameoflife.png}
	\caption{2.2 -- GUI GameOfLife}
	\includegraphics[width=2.5cm]{Obrazy/patterns.png}
	\caption{2.3 -- Zakładka ,,Patterns'' z bocznego menu}
	\includegraphics[width=2.5cm]{Obrazy/patternseditor.png}
